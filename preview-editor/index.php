...
<html>
    ...
    <style>
        /*Do not add this, just for local testing - START*/
        @media (max-width:525px) {
            .wbdiv{
                width:320px !important;
            }
        }
        /*Do not add this, just for local testing - END*/
        .wbdiv {
            width:528px;
            height:100%;
            margin: 0 auto;      
      ...
      @font-face {
                font-family: 'icomoon';
                src:    url('fonts/icomoon.eot?ask43t');
                src:    url('fonts/icomoon.eot?ask43t#iefix') format('embedded-opentype'),
                    url('fonts/icomoon.ttf?ask43t') format('truetype'),
                    url('fonts/icomoon.woff?ask43t') format('woff'),
                    url('fonts/icomoon.svg?ask43t#icomoon') format('svg');
                font-weight: normal;
                font-style: normal;
            }
...
//==================================================
            ...
            $('#front-start-icon').change(function () {
                var classname = $('#front-start-icon option:selected').attr('class');
                console.log(classname);
                $('#front-start-icon').attr('class', classname);

                $('#front-start').attr('class', classname);
                $('#front-start').empty().append($('#front-start-icon').val());
            });
            $("#front-end-icon").change(function () {
                 var classname = $('#front-end-icon option:selected').attr('class');
                console.log(classname);
                $('#front-end-icon').attr('class', classname);

                $('#front-end').attr('class', classname);
...
//                $('#bandtextpathinside1')[0].setAttribute('startOffset', '0%');
            ...
            $("#txtInputCont").on('custom', function (e, cpos) {
                ...
                if ($("#bandtextcontainer")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['ContMax'])) {
                    ...
                    if ($("#bandtextcontainer")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['ContMin'])) {
...
//                        alert($("#bandtextcontainer")[0].getBoundingClientRect().width);
                        $("#front-endcont1").empty().append($("#front-endcont2-icon :selected").text());
                        $("#front-endcont2").empty();
            ...
            $("#txtInputInside").on('custom', function (e, cpos) {
                ...
                if ($("#bandtextcontainer2")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['InsideMax'])) {
                    ...
                    disableWrapped2();
                    if ($("#bandtextcontainer2")[0].getBoundingClientRect().width < (wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['InsideMin'])) {
                        $("#front-endinside1").empty().append($("#front-endinside2-icon :selected").text());
                        $("#front-endinside2").empty();
                ...
                <tr>
                    ...
                    <td>
                        <select id="front-start-icon" class="fa">
                            ...
                            <option class="fa" value="&#xf1d8;">&#xf1d8;</option>
                            <option class="fa" value="&#xf1ba;">&#xf1ba;</option>
                            <option class="icon-First_Aid_2" value="&#xe907;">&#xe907;</option>
                            <option class="icon-home" value="&#xe900;">&#xe900;</option>
                            <option class="icon-home2" value="&#xe901;">&#xe901;</option>
                            <option class="icon-home3" value="&#xe902;">&#xe902;</option>
                            <option class="icon-office" value="&#xe903;">&#xe903;</option>
                            <option class="icon-pacman" value="&#x1f435;">&#x1f435;</option>                            
                        </select>                        
                    </td>                    
...
<script>
    function changeFontSize() {
        ...
        if (textdesign === 'frontback') {
            $("#txtInput1").trigger("paste");
            $("#txtInput2").trigger("paste");
        } else if (textdesign === 'cont') {
            $("#txtInputCont").trigger("paste");
        } else {
            $("#txtInputInside").trigger("paste");
        }
    }
