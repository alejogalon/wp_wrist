...
//END - prevent any key long pressing
            ...
            $("#txtInput1").on('cut', function () {
                $("#txtInput1").val('');
                $('input[name=frontPaste]').val(0);
            ...
            $("#txtInput1").on('change keyup copy', function (e) {
                ...
                if (e.keyCode === 46 || e.keyCode === 8) {
                    if ($('input[name=frontPaste]').val() === '1') {
                        document.getElementById("bandtext1").style.fontSize = wb[$("#ddlSize").val()]['MaxFont'] + 'px';
                        $('#bandtext1')[0].setAttribute('lengthAdjust', '');
                        $('#bandtext1')[0].setAttribute('textLength', '');
                        $("#txtInput1").val("");
                        ...
                        if ($("#txtInput1").val().length > $('input[name=fbfront]').val()) {
                            ...
                            $('#bandtext1')[0].setAttribute('textLength', '');
                            for (d = 1; d < 10; d++) {
                                if (($("#bandtext1")[0].getBoundingClientRect().width < pathLength) && (parseInt($("#bandtext1").css('font-size')) < (wb[$("#ddlSize").val()]['MaxFont']))) {
                ...
                if (e.keyCode === 46 || e.keyCode === 8) {
                    if ($('input[name=backPaste]').val() === '1') {
                        ...
                        if ($("#txtInput2").val().length > $('input[name=fbback]').val()) {
                            ...
                            $('#bandtext2')[0].setAttribute('textLength', '');
                            for (d = 1; d < 10; d++) {
                                if (($("#bandtext2")[0].getBoundingClientRect().width < pathLength) && (parseInt($("#bandtext2").css('font-size')) < (wb[$("#ddlSize").val()]['MaxFont']))) {
