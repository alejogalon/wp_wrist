...
//==================================================
            ...
            $("#txtInput1").on('custom', function (e) {
                ...
                if ($("#txtInput1").val().length > 25) {
                    ...
                    for (d = 1; d < 100; d++) {
                        if (($("#bandtext1")[0].getBoundingClientRect().width < wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['FBPathDelete']) && (parseInt($("#bandtext1").css('font-size')) < (wb[$("#ddlSize").val()]['MaxFont']))) {
                    ...
                    for (d = 1; d < 100; d++) {
                        if (($("#bandtext1")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['FBPathLimit']))
            ...
            $("#txtInput2").on('custom', function (e) {
                ...
                if ($("#txtInput2").val().length > 25) {
                    ...
                    for (d = 1; d < 100; d++) {
                        if (($("#bandtext2")[0].getBoundingClientRect().width < wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['FBPathDelete']) && (parseInt($("#bandtext2").css('font-size')) < (wb[$("#ddlSize").val()]['MaxFont']))) {
                    ...
                    for (d = 1; d < 100; d++) {
                        if (($("#bandtext2")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()][$('.wbdiv').width()]['FBPathLimit']))
...
//                $('#bandtextpathinside1')[0].setAttribute('startOffset', '0%');
            ...
            $("#txtInputCont").on('custom', function (e) {
                if (e.keyCode === 46 || e.keyCode === 8) {
            ...
            $("#txtInputInside").on('custom', function (e) {
