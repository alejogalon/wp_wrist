...
//END - prevent any key long pressing
            ...
            $("#txtInput1").on('change keyup copy', function (e) {
                ...
                timer = setTimeout(function () {
                    ...
                    if ($("#txtInput1").val().length > 30) {
                        ...
                        for (d = 1; d < 100; d++) {
                            if (($("#bandtext1")[0].getBoundingClientRect().width < wb[$('input[name=wbsize]').val()]['FBPathDelete']) && (parseInt($("#bandtext1").css('font-size')) < (wb[$("#ddlSize").val()]['MaxFont']))) {
                        ...
                        for (d = 1; d < 100; d++) {
                            if (($("#bandtext1")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()]['FBPathLimit'] - 50))
                                    && (parseInt($("#bandtext1").css('font-size')) > 9)) {
                        ...
                        if (e.keyCode !== 46 || e.keyCode !== 8) {
                            for (d = 1; d < 100; d++) {
                                if (($("#bandtext1")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()]['FBPathLimit'] - 40))
                                        && (parseInt($("#bandtext1").css('font-size')) > 9)) {
            ...
            $("#txtInput2").on('change keyup copy', function (e) {
                ...
                timer = setTimeout(function ()
                {
                    ...
                    if ($("#txtInput2").val().length > 30) {
                        ...
                        for (d = 1; d < 100; d++) {
                            if (($("#bandtext2")[0].getBoundingClientRect().width < wb[$('input[name=wbsize]').val()]['FBPathDelete']) && (parseInt($("#bandtext2").css('font-size')) < (wb[$("#ddlSize").val()]['MaxFont']))) {
                        ...
                        for (d = 1; d < 100; d++) {
                            if (($("#bandtext2")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()]['FBPathLimit'] - 50))
                        ...
                        if (e.keyCode !== 46 || e.keyCode !== 8) {
                            for (d = 1; d < 100; d++) {
                                if (($("#bandtext2")[0].getBoundingClientRect().width > (wb[$('input[name=wbsize]').val()]['FBPathLimit'] - 40))
                                        && (parseInt($("#bandtext2").css('font-size')) > 12)) {
...
//                $('#bandtextpathinside1')[0].setAttribute('startOffset', '0%');
            ...
            $("#txtInputInside").on('paste', function () {
                $('input[name=backPaste]').val(1);
            });
