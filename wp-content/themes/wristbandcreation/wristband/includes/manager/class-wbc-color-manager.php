...
if (!class_exists('WBC_Color_Manager')) {
    class WBC_Color_Manager extends WBC_Manager
    {
        ...
        public function register() {
            ...
            $this->register_field_group(array (
                ...
                'fields' => array (
                    array (
                        ...
                        'label' => 'Text Color or Layer Color(Dual Layer)',
                        'name' => 'text_color',
                        'type' => 'repeater',
                        'sub_fields' => array (
                            array (
            ...
            $this->register_field_group(array (
                'id' => 'acf_pantone-colors-field',
                'title' => 'Pantone Colors Field',
                'fields' => array (
                    array (
                        'key' => 'field_5791bc31caf50',
                        'label' => 'Pantone Color',
                        'name' => 'pantone_color',
                        'type' => 'repeater',
                        'sub_fields' => array (
                            array (
                                'key' => 'field_5791bc66caf52',
                                'label' => 'Name',
                                'name' => 'name',
                                'type' => 'text',
                                'column_width' => '',
        ...
        */
        ...
        public function get_settings($settings) {
            ...
            $acf_pantone_color = get_field('pantone_color', 'option');
            if ($acf_pantone_color) {
                foreach ($acf_pantone_color as $key => $value) {
                    $settings['pantone_color'][] = array('pantone_name' => $value['name'], 'color_number' => $value['color_number']);
                }
            }
