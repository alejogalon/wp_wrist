jQuery(function ($) {
    ...
    var Settings = WBC.settings,
            ...
            Builder = {
                ...
                appendsetupAlertMsg: function (_msg, el, uniq_class) {
                    var spl = Mustache.render('<span class="alert-notify alert-color ' + uniq_class + '">{{{message}}}</span>', {message: _msg});
                            ...
                            beforeSend: function (xhr) {
                                ...
                                $.each(data.result.files, function (index, file) {  
                                    ...
                                    if(filename.length <= 6) {
                                        ...
                                        filename = filename.substr(0, 6) + (name.length > 6 ? '[...]' : '');
                                        name = filename + '.' + ext;
                                    }
                                    ...
                                    $self.closest('.button-box').find('.file-name-class').remove();
                                    $self.closest('.button-box')
                                            .append('<span class="file-name-class">'+name+'</span>');

                                    switch (position) {
                                        case "front_start":
                                              $('#fm101_before_style').detach();
                                              $('<style id="fm101_before_style" type="text/css">h3#fm101:before {font-family: upload-placeholder;content:" ";line-height: 1px;}</style>').appendTo('head');
                                            break;
                                        case "front_end":
                                            $('#fm101_after_style').detach();
                                            $("<style id='fm101_after_style' type='text/css'>h3#fm101:after {font-family: upload-placeholder;content: ' ';line-height: 1px;}</style>").appendTo('head');
                                            break;
                                        case "back_start":
                                            $('#bm101_before_style').detach();
                                            $("<style id='bm101_before_style' type='text/css'>h3#bm101:before {font-family: upload-placeholder;content: ' ';line-height: 1px;}</style>").appendTo('head');
                                          break;
                                        case "back_end":
                                            $('#bm101_after_style').detach();
                                            $("<style id='bm101_after_style' type='text/css'>h3#bm101:after {font-family: upload-placeholder;content: ' ';line-height: 1px;}</style>").appendTo('head');
                                         break;
                                        case "wrap_start":
                                            $('#Cm101_before_style').detach();
                                            $("<style id='Cm101_before_style' type='text/css'>h3#Cm101:before {font-family: upload-placeholder;content: ' ';line-height: 1px;}</style>").appendTo('head');
                                            break;
                                        case "wrap_end":
                                            $('#Cm101_after_style').detach();
                                            $("<style id='Cm101_after_style' type='text/css'>h3#Cm101:after {font-family: upload-placeholder;content: ' ';line-height: 1px;}</style>").appendTo('head');
                                            break;
                                        case "center":
                                            $('#centerclip').text('');
                ...
                collectDataToPost: function () {
                    var addtional_options = [],
                        packaging_options = $('input[name="packaging_option[]"]:checked').val(),
                        packaging_image = '',
                    ...
                    // }
                    if ($('input[name="convert_value"]:checked').val() == 'convert-other'){
                        convert_to_keychains_message = parseFloat($('input[name="convert_value_number"]').val());
                    } else if($('input[name="convert_value"]:checked').val() == 'convert-hundred'){
                        convert_to_keychains_message = 100
                    } else if($('input[name="convert_value"]:checked').val() == 'convert-all'){
                        convert_to_keychains_message = this.data.total_qty; 
                    } else {
                        convert_to_keychains_message = '';
                    }
                    ...
                    if ($('input[name="packaging_option[]"]:checked').val() != 'No Packaging' && $('input[name="packaging_option[]"]:checked').val() != 'Individual Packaging') {
                        if ($('#email-later').prop('checked')) {
                            packaging_image = 'Email this later';
                        }
                        else {
                            packaging_image = $('#packaging_imagename').text();
                        }     
                    }else{
                        packaging_image = '';
                    }
                    ...
                    $.extend(this.data, {
                        ...
                        customer_email: $('input#customer-email').val(),
                        customer_firstname: $('input#customer-name').val(),
                ...
                _colorStylePrice: function (qty) {
                    ...
                    var id =  ''+$("#selected_color_table tr:last").attr('id');
                    var counter = id.split('-');
                    color_style = $('#colorBox-' + counter[1] +' div.color-wrap').attr('data-w_type');
                    ...
                    /*if ($('.color-wrap.selected').eq(0).attr('title')) { 
                        //nothin
                    ...
                    if (Settings.color_style[styleID].price_list) {
                        ...
                        this.data.total_price += additional;
                        //console.log(qty+' - '+additional);
                         if (qty > 0){
                            styleID = $('input[name="color_style"]:checked').val(); 

                            color_style_cost = Settings.color_style[styleID].price_list,
                            value = this.rangePrice(color_style_cost, qty);
                            if(value != undefined){
                        ...
                        if (additional_price > 0) {
                            if (costType == 'Each Quantity') {
                                if ($(this).data('key') == 'convert_to_keychains') {
                                    ...
                                    $('.convertvalue-message-class').remove();
                                    if ($('input[name="convert_value"]:checked').val() == 'convert-other'){
                                        ...
                                        if (qty >= value){
                                            ...
                                            Builder.addappendAlertMsg('Total quantity is below conversion value',$('label[for="convert-other"]'),'convertvalue-message-class'); 
                                        }
                                        ...
                                        if (qty >= 100) {
                                            ...
                                            $('input[name="convert_value"]:checked').prop('checked', false);
                                            $('input[name="convert_value"]:checked').val('convert-hundred').attr('disabled', true);
                                        }
                                    } else if($('input[name="convert_value"]:checked').val() == 'convert-all'){
                ...
                _packagingOptions: function (qty) {
                    // $('.convert-keychains-message').remove();
                    $('input[name="packaging_option[]"]:checked').each(function () {
                        var price_list = Settings['packaging_options'][$(this).data('key')].price_list,
                                costType = Settings['packaging_options'][$(this).data('key')].cost_type,
                                setup_price_list = Settings['packaging_options'][$(this).data('key')].setup_price_list,
                                additional_price = Builder.rangePrice(price_list, qty);
                        var total = 0;
                        //console.log(additional_price+' - '+qty)
                        //alert(costType + "====" + additional_price)
                        // $(this).closest('.checkbox').closest('.checkbox').find('.each-message').remove();
                        
                        if (additional_price > 0) {
                            if (costType == 'Each Quantity') {
                                total = additional_price * qty;
                                Builder.data.total_price += total+parseInt(setup_price_list);
                                ...
                                var spl = Mustache.render('+{{{currency_symbol}}}{{price}} fixed', {
                                    currency_symbol: Settings.currency_symbol,
                                    price: numberFormat(parseInt(setup_price_list), 2),
                                });
                                Builder.addappendAlertMsg(tpl, $(this).closest('.checkbox'), 'each-message');
                                if (parseInt(setup_price_list) > 0) {
                                    Builder.appendsetupAlertMsg(spl, $(this).closest('.checkbox'), 'fixed-message');
                                }else{
    ...
    function wctColorEnable() {
       /* $('#wristband-color-tab li.color-enabled').each(function () {
        ...
        $("#selected_color_table tr").each(function(){
            var id =  ''+ $(this).attr("id");
            var counter = id.split('-');
            color_style = $('#colorBox-' + counter[1] +' div.color-wrap').attr('data-w_type');
            txtcolor =  $('#colorBox-' + counter[1] +' div.color-wrap').attr('data-textcolor');
            bgcolor = $('#colorBox-' + counter[1] +' div.color-wrap div').attr('data-color');
        });

        if(color_style == undefined || bgcolor == undefined){
            bgcolor = '#707070';
            color_style = 'Solid';
            $('#front-back-text-container').css('background-color', bgcolor);
            $('#full-text-container').css('background-color', bgcolor);
            $('#inside-text-container').css('background-color', bgcolor);
            $('.copy-preview-font-inside').css('color',bgcolor);
            $('.fig-first-color').css({'background-color' : bgcolor});
            $('.fig-second-color').css({'background-color' : bgcolor});
            $('.fig-third-color').css({'background-color' : bgcolor});
            $('.first-color').css({'background-color' : bgcolor});
            $('.second-color').css({'background-color' : bgcolor});
            $('.third-color').css({'background-color' : bgcolor});
            $('.font_mobil_halfcircled').css('background-color', bgcolor);
            $('.back_mobil_halfcircled').css('background-color', bgcolor);
            $('.copy-preview-clipart').css('color', bgcolor );
            $('#box_figured').css('background-color', bgcolor);
        }
        $('#full-text-container').css('background-color', '#707070');
        //console.log(color_style+' - '+txtcolor+' - '+bgcolor);
        
        $('input[name="color_style"][value="' + color_style + '"]').prop('checked', true);

        $('#wbcolor li').removeClass('active');
        $('#wbcolor a#'+color_style.toLowerCase()).parent().addClass('active');
        $('#wristband-color-tab .tab-pane').removeClass('active in');
        $('#wristband-color-tab #tab-'+color_style.toLowerCase()).addClass('active in');        

        if(color_style == 'Segmented'){
            $('.swirlcolor').hide();
            $('.seg').show();
            tab = '#tab-segmented';
            txtcolor = '#707070';
            $('.inside-msg-text').css('color', txtcolor );
        }else if(color_style == 'Swirl'){
            $('.swirlcolor').show();
            $('.seg').hide();
            tab = '#tab-swirl';
            txtcolor = '#707070';
        ...
        console.log(tab);
        $(tab+" #wristband-bg-color div[data-color='" + bgcolor + "']").parent().addClass('selected');

        $("#wristband-text-color .color-box").removeClass('selected');
        if(style == "Imprinted" || style == "Deboss-Fill" || style == "Emboss-Printed" || style == "Dual Layer" ){
            var exist =  $("#wristband-text-color ul").find("div[data-color='" + txtcolor + "']");
            console.log(txtcolor+' - '+exist.length);
            if(exist.length > 0) {
                $("#wristband-text-color ul div[data-color='" + txtcolor + "']").parent().addClass('selected');   
            }else{
                txtcolor = 'rgba(255,255,255, 0.2)';
                $('.copy-preview-font').css('color',txtcolor);
                $('.copy-preview-clipart').css('color', txtcolor );
                //$("#wristband-text-color ul div[data-color='" + txtcolor.toUpperCase() + "']").parent().addClass('selected');  
            }
            $('.color-text-added').trigger("click");
        }
        return false;
        //$('ul#wbcolor li a#'+color_style.toLowerCase()+' input:radio').trigger("click");
    ...
    function StartEdit() {
        ...
        // $('input#customer-email').val(val[27]);
        // $('input#customer-name').val(val[28]);
        
        var packaging = val[23];
        var packagingImage = val[24];
        LoadPackagingOption(packaging, packagingImage);
        ...
        setTimeout(function () {
            ...
            var id =  ''+$("#selected_color_table tr:last").attr('id');
            var counter = id.split('-');
            color_bg = $('#colorBox-' + counter[1] +' div.color-wrap div').attr('data-color');
            color_style = $('#colorBox-' + counter[1] +' div.color-wrap').attr('data-w_type').toLowerCase();

            $('#wristband-color-tab .tab-pane').removeClass('active in');
            $('#wristband-color-tab #tab-'+color_style).addClass('active in');
            $('#tab-'+color_style+' ul#wristband-bg-color div[data-color="'+color_bg+'"]').parent().addClass("selected");
            $('ul#wbcolor li a#'+color_style+' div#radio_'+color_style+' input:radio').attr('checked', true);
            //$('ul#wbcolor li a#'+color_style+' div#radio_'+color_style+' input:radio').trigger('click');
        ...
        LoadAdditionalOption(val[6], val[7], val[8], val[9], val[20], val[21], val[22], val[25], val[26]);
    }
    ...
    function ChooseLastColor(MultiAdd) {
        ...
        for (var x = 0; x <= SplitItem.length - 1; x++) {
            ...
            if(x == SplitItem.length - 1){
                ...
                var txtcolor = TempSplit[4];
                bgcolor = TempSplit[2];
                colorStyle = getcolorstyle;

                var style = $("#style").find("option:selected").text();
                //console.log(style+' '+getcolorstyle+' '+bgcolor+' '+txtcolor);
                //console.log(TempSplit[4]);
                $("#selected_wristband").attr('data-color', bgcolor);
                $("#selected_wristband").attr('data-colorstyle', getcolorstyle);
                $('#wbcolor a#'+getcolorstyle).parent().addClass('active');
        ...
        //$("#wristband-bg-color div[data-color='" + bgcolor + "']").parent().addClass('selected');
    }
    ...
    function SetProdShipTime(C_location, C_date_prod, C_date_ship) {
        ...
        if (!Number(TmpDateship)) {
            if(TmpDateship == 'International'){
                //$("#customization_date_shipping").val(4);
                $("#customization_date_shipping:contains('International') option").attr('selected', 'selected');
            }else{
    ...
    function LoadAdditionalOption(Repellant, Eco, Thick, DigitalPro, ConvertKeyChains, ConvertMsg, totalqty, Glitters, Sequentially) {
        $('input[name="additional_option[]"]').each(function () {
            //console.log($(this).val());
            if ($(this).val() == Repellant) {
                $(this).attr('checked', true);
                ...
                $(this).attr('checked', true);
            } else if ($(this).val() == Glitters) {
                $(this).attr('checked', true);
            } else if ($(this).val() == Sequentially) {
                $(this).attr('checked', true);        
            }  else if ($(this).val() == ConvertKeyChains) {
                $(this).attr('checked', true);
                if(ConvertMsg == totalqty){
                    $("#convert-all").prop("checked", true);
                } else if ( ConvertMsg == 100 ){
                    $("#convert-hundred").prop("checked", true);
                } else {
                    $('input[name="convert_value_number"]').val(ConvertMsg);
                    $("#convert-other").prop("checked", true);

                }
                setTimeout(function () {
                    $('#modal-keychain').modal('show');
                    $('.keychain-col').show();
                }, 10000);
            }
        });
    ...
    function LoadPackagingOption(packaging, packagingImage) {
        $('input:radio[name="packaging_option[]"][value="'+packaging+'"]').attr('checked',true);
        
        if(packaging != "No Packaging" && packaging != "Individual Packaging" ){
            if (packagingImage=='Email this later') {
                
                $('#email-later').attr('checked',true);
                $('.files-data').attr('disabled',true);      
            }
            else {
                $('#packaging_error_warning').text(packagingImage).css({display:'block', color: '#008000', 'font-size': '10px', 'text-align': 'center'});
                $('#packaging_imagename').text(packagingImage); 

                $('#custom-packaging .fileinput-button')
                    .find('.image-upload')
                    .attr('src', '/wp-content/themes/wristbandcreation/images/custom-logo-3-v1.png')
                    .css({display: 'inline-block'})
                    .end()
                    .find('span')
                    .css({'padding-left': '0','position': 'relative', 'left': '0'})
                    .text('')
                    .end()
                    .find('.fa-spinner')
                    .css({'margin-left': '0'})
            ...
            $('#custom-packaging').show();

        }else{
            $('#custom-packaging').hide();         
            $('#packaging_imagename').text('');   
        }
    }
    ...
    function LoadPicture(FS, FE, BS, BE, VP, WristStat, WS, WE ,CE) {
        $('.clipart-list li').each(function () {
            ...
            var icon = $(this).data('icon');
             if ($(this).data('icon') == FS) {
                ...
                if(icon.indexOf('fa-') > -1){
                    $('#fm101_before_style').detach();
                    $("<style id='fm101_before_style' type='text/css'>h3#fm101:before {font-family: FontAwesome;content: '"+glyp+"';line-height: 1px;margin-right:5px;font-size:95%;}</style>").appendTo('head');
                } else {
                    $('#fm101_before_style').detach();
                    $("<style id='fm101_before_style' type='text/css'>h3#fm101:before {font-family: icomoon;content: '"+glyp+"';line-height: 1px;margin-right:5px;font-size:85%;}</style>").appendTo('head');
                }
            ...
            if ($(this).data('icon') == FE) {
                ...
                if(icon.indexOf('fa-') > -1){
                    $('#fm101_after_style').detach();
                    $("<style id='fm101_after_style' type='text/css'>h3#fm101:after {font-family: FontAwesome;content: '"+glyp+"';line-height: 1px;margin-left:5px;font-size:95%;}</style>").appendTo('head');
                }else {
                    $('#fm101_after_style').detach();
                    $("<style id='fm101_after_style' type='text/css'>h3#fm101:after {font-family: icomoon;content: '"+glyp+"';line-height: 1px;margin-left:5px;font-size:85%;}</style>").appendTo('head');
                }
            ...
            if ($(this).data('icon') == BS) {
                ...
                if(icon.indexOf('fa-') > -1){
                    $('#bm101_before_style').detach()
                    $("<style id='bm101_before_style' type='text/css'>h3#bm101:before {font-family: FontAwesome;content: '"+glyp+"';line-height: 1px;margin-right:5px;font-size:95%;}</style>").appendTo('head');
                } else {
                    $('#bm101_before_style').detach();
                    $("<style id='bm101_before_style' type='text/css'>h3#bm101:before {font-family: icomoon;content: '"+glyp+"';line-height: 1px;margin-right:5px;font-size:85%;}</style>").appendTo('head');
                }
            ...
            if ($(this).data('icon') == BE) {
                ...
                if(icon.indexOf('fa-') > -1){
                    $('#bm101_after_style').detach();
                    $("<style id='bm101_after_style' type='text/css'>h3#bm101:after {font-family: FontAwesome;content: '"+glyp+"';line-height: 1px;margin-left:5px;font-size:95%;}</style>").appendTo('head');   
                }else {
                    $('#bm101_after_style').detach();
                    $("<style id='bm101_after_style' type='text/css'>h3#bm101:after {font-family: icomoon;content: '"+glyp+"';line-height: 1px;margin-left:5px;font-size:85%;}</style>").appendTo('head');
                }
            ...
            if ($(this).data('icon') == WS) {
                ...
                if(icon.indexOf('fa-') > -1){
                    $('#Cm101_before_style').detach();
                    $("<style id='Cm101_before_style' type='text/css'>h3#Cm101:before {font-family: FontAwesome;content: '"+glyp+"';line-height: normal;margin-right:5px;font-size:95%;}</style>").appendTo('head');
                }else {
                    $('#Cm101_before_style').detach();
                    $("<style id='Cm101_before_style' type='text/css'>h3#Cm101:before {font-family: icomoon;content: '"+glyp+"';line-height: 1px;margin-right:5px;font-size:85%;}</style>").appendTo('head'); 
                }
            ...
            if ($(this).data('icon') == WE) {
                ...
                if(icon.indexOf('fa-') > -1){
                    $('#Cm101_after_style').detach();
                    $("<style id='Cm101_after_style' type='text/css'>h3#Cm101:after {font-family: FontAwesome;content: '"+glyp+"';line-height: normal;margin-left:5px;font-size:95%;}</style>").appendTo('head');
                }else {
                    $('#Cm101_after_style').detach();
                    $("<style id='Cm101_after_style' type='text/css'>h3#Cm101:after {font-family: icomoon;content: '"+glyp+"';line-height: normal;margin-left:5px;font-size:85%;}</style>").appendTo('head'); 
                }
...
//              alert(colors[0] + '|' + colors[1] + '|' + colors[2]);
    ...
    function AddNewColor($wc) {
        ...
        if (SaveStatus) {
            ...
            console.log('asjdhaskdhaskdhsakljhakljd')
    ...
    function checkConvert() {
       var total_qty = Builder.data.total_qty;
       var convert_number = Builder.data.convert_message;

       if (convert_number > total_qty) {
        Builder.appendAlertMsg('Convert quantity is greater than the total quantity',$('#qty_handler'),'total-qty-alert');
            return 'error';
       }
    }
    ...
    function captureAddcart(link) {
        // var emailFormat = /\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*/;
        
        // if (emailFormat.test($('input#customer-email').val()))
        // {
            ...
            //         wc_colors += 'Text Color: ' + val.text_color_name + ', ';
            // });
            ...
            // $("#inf_field_FirstName").val(holdData.customer_firstname);
            // $("#inf_field_Email").val(holdData.customer_email);    
            $("#inf_custom_Design1").val(link);
            $("#inf_custom_Style").val(holdData.title);
            $("#inf_custom_Size").val(holdData.size);
            $("#inf_custom_Colors0").text();
            ...
            $("#inf_custom_Packaging").val(holdData.packaging_options);
            $("#inf_custom_PackagingImage").val(holdData.packaging_image);
            $("#inf_custom_FrontStart").val(holdData.clipart.front_start);
            $("#inf_custom_FrontEnd").val(holdData.clipart.front_end);
            $("#inf_custom_FiguredLogo").val(holdData.clipart.center);
            ...
            $("input[name=inf_option_TypeofLeads]").removeAttr('checked');
            $("#inf_option_TypeofLeads_400").attr('checked', 'checked');
            //$("#infusion-form").submit();       
        //} else {
            //$('input#customer-email').addClass('borderRed');
        //}
    }
    function validateEmail() {
        var emailFormat = /\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*/;
        if($('input#customer-email').val()!=""){
            if (emailFormat.test($('input#customer-email').val())) {
                $('input#customer-email').removeClass('borderRed');
                $('.col-customer-email').find('.validate-email-alert').remove();
            }else {
                $('input#customer-email').addClass('borderRed');
                Builder.appendAlertMsg('Please enter a valid Email Address',$('#customer-email'),'validate-email-alert');
            }
        }else{
            $('input#customer-email').removeClass('borderRed');
            $('.col-customer-email').find('.validate-email-alert').remove();
...
//                                    }
                        ...
                        for (var index in lists) {
                            ...
                            var row_tpl = Mustache.render(
                                    '<tr data-name="{{name}}" class="option-tr" id="Tr-' + TempID + '">'
                                    + '<td style="text-align: left" id="colorBox-' + TempID + '"><div class="DivColorBox">{{{wristband_color_box}}}</div></td>'
                                    + '<td style="text-align: left"><left><span style="font-weight: bold;" id="spanAdult-' + TempID + '" class="spanAdult">{{{adult_qt}}}</span><span id="spanAdultup-' + TempID + '" class="CssAddup" data-plus="{{{num_aqE}}}">{{{num_aqE_view}}}</span><input type="number" min="0" class="input-text fusion-one-third InpCss keyupTxtView" id="inpAdult-' + TempID + '" value="{{{num_aq}}}"><span id="spanAdultupE-' + TempID + '" class="CssAddup keyupSpanEdit" style="display:none">+</span><input type="number" min="0" class="input-text fusion-one-third InpCss CssAddup keyupTxtEdit" id="inpAdultE-' + TempID + '" value="{{{num_aqE}}}"></left></td>'
                                    + '<td style="text-align: left"><left><span style="font-weight: bold;" id="spanMedium-' + TempID + '" class="spanMedium">{{{medium_qty}}}</span><span id="spanMediumup-' + TempID + '" class="CssAddup" data-plus="{{{num_mqE}}}">{{{num_mqE_view}}}</span><input type="number" min="0" class="input-text fusion-one-third InpCss keyupTxtView" id="inpMedium-' + TempID + '" value="{{{num_mq}}}"><span id="spanMediumupE-' + TempID + '" class="CssAddup keyupSpanEdit" style="display:none">+</span><input type="number" min="0" class="input-text fusion-one-third InpCss CssAddup keyupTxtEdit" id="inpMediumE-' + TempID + '" value="{{{num_mqE}}}"></left></td>'
                                    + '<td style="text-align: left"><left><span style="font-weight: bold;" id="spanYouth-' + TempID + '" class="spanYouth">{{{youth_qty}}}</span><span id="spanYouthup-' + TempID + '" class="CssAddup" data-plus="{{{num_yqE}}}">{{{num_yqE_view}}}</span><input type="number" min="0" class="input-text fusion-one-third InpCss keyupTxtView" id="inpYouth-' + TempID + '" value="{{{num_yq}}}"><span id="spanYouthupE-' + TempID + '" class="CssAddup keyupSpanEdit" style="display:none">+</span><input type="number" min="0" class="input-text fusion-one-third InpCss CssAddup keyupTxtEdit" id="inpYouthE-' + TempID + '" value="{{{num_yqE}}}"></left></td>'
                                    + '<td style="text-align: left" id="colorTextBox-' + TempID + '"><center>{{{wristband_text_color_box}}}</center></td>'
                                    //+ '<td colspan="1" style="text-align: right;"><a style="display:none;" href="#" id="EditID-' + TempID +'"  data-name="{{name}}" class="edit-selection" data-tempID="' + TempID +'">Edit</a><a id="DelID-' + TempID +'" href="#" class="delete-selection CssTitleRed font-size-11" data-tempID="' + TempID +'" data-name="{{name}}" data-textname="{{textColorName}}" data-type="{{Wrist_Type}}">Delete</a></td>'
                                    + '<td colspan="1" style="text-align: right;"><a style="display:none;" href="#" id="EditID-' + TempID + '"  data-name="{{name}}" class="edit-selection" data-tempID="' + TempID + '">Edit</a><a id="DelID-' + TempID + '" href="#" class="delete-selection CssTitleRed font-size-11" data-tempID="' + TempID + '" data-name="{{name}}" data-textname="{{textColorName}}" data-type="{{Wrist_Type}}"><i class="fa fa-times"></i></a></td>'
                                    + '</tr>',
                    ...
                    var width = $("#width").val();
                    var selected_width = $("#selected_wristband").attr('data-size');
                    var selected_style = $("#selected_wristband").attr('data-style');
                    if(typeof selected_width !== "undefined" && selected_width && selected_style == $('#style option:selected').text()){    
                        $('select#width').val(selected_width);
                        //$("#selected_wristband").removeAttr('data-size').removeAttr('data-style');
                    }
...
**/
                .on('change', 'select#width', function () {
                    var selected_width = $("#selected_wristband").attr('data-size');
                    var selected_style = $("#selected_wristband").attr('data-style');
                    Builder.renderPriceChart();
                    if(typeof selected_width !== "undefined" && selected_width){                
                        Builder.renderProductionShippingOptions();
                    }  
                })
                ...
                .on('shown.bs.tab', '#wristband-color-tab li a[data-toggle="tab"]', function () {
                    $('#wristband-color-tab .color_style').attr('checked', false);
...
$("<style id='Cm101_after_style' type='text/css'>h3#Cm101:after {font-family: FontAwesome;content: '"+glyp+"';line-height: normal;margin-left:5px;font-size:95%;}</style>").appendTo('head');
                            ...
                            case "front_start":
                                $('#fm101_before_style').detach();
$("<style id='fm101_before_style' type='text/css'>h3#fm101:before {font-family: icomoon;content: '"+glyp+"';line-height: 1px;margin-right:5px;font-size:85%;}</style>").appendTo('head');                                break;
                            case "front_end":
                                $('#fm101_after_style').detach();
$("<style id='fm101_after_style' type='text/css'>h3#fm101:after {font-family: icomoon;content: '"+glyp+"';line-height: 1px;margin-left:5px;font-size:85%;}</style>").appendTo('head');
                                break;
...
$("<style id='Cm101_after_style' type='text/css'>h3#Cm101:after {font-family: icomoon;content: '"+glyp+"';line-height: normal;margin-left:5px;font-size:85%;}</style>").appendTo('head');
                ...
                .on('click', 'ul.font-class li', function (e) {
                    ...
                    $('#selectFont').trigger('change');
                     if (fontStyle=='Wood Shop')
                    {
                        $('#fm101').css('top','45%');
                        $('#bm101').css('top','45%');
                        $('#Im101').css('top','45%');
                        $('#Cm101').css('top','45%');
                        $('#fm101').css('transform','translateY(-63%)');
                        $('#bm101').css('transform','translateY(-63%)');
                        $('#Im101').css('transform','translateY(-63%)');
                        $('#Cm101').css('transform','translateY(-63%)');
                        $('#fm101').css('position','relative');
                        $('#bm101').css('position','relative');
                        $('#Im101').css('position','relative');
                        $('#Cm101').css('position','relative');
                    } else {
                        $('#fm101').css('top','initial');
                        $('#bm101').css('top','initial');
                        $('#Im101').css('top','initial');
                        $('#Cm101').css('top','initial');
                        $('#fm101').css('transform','initial');
                        $('#bm101').css('transform','initial');
                        $('#Im101').css('transform','initial');
                        $('#Cm101').css('transform','initial');
                        $('#fm101').css('position','initial');
                        $('#bm101').css('position','initial');
                        $('#Im101').css('position','initial');
                        $('#Cm101').css('position','initial');
                    }
                })
                ...
                .on('click', '.packaging-option-item', function (e) {
                    
                    $(this).find('input').attr('checked','checked');
                    
                    if($(this).find($('input[name="packaging_option[]"]:checked')).val() != "No Packaging" && $(this).find($('input[name="packaging_option[]"]:checked')).val() != "Individual Packaging" ){          
                        $('#custom-packaging').show();                          
                    }else{
                        //console.log($(this).find($('input[name="packaging_option[]"]:checked')).val());
                        $('#custom-packaging').hide();         
                    }
                    Builder.observer();
                    //console.log($(this).find($('input[name="packaging_option[]"]:checked')).val());
                ...
                .on('change', 'input[name = "packaging_option[]"]', function (e) {
                    if($(this).val() != "No Packaging" || $(this).val() != "Individual Packaging" ){
                        $('#custom-packaging').show();                          
                    }else{
                        //console.log($(this).val());
                        $('#custom-packaging').hide();         
                ...
                .on('click', '#email-later-container', function (e) {
                    if ($(e.target).is('input:checkbox'))
                        return;
                    var $checkbox = $(this).find(':checkbox');
                    $checkbox.attr('checked', !$checkbox[0].checked);
                    if ($(this).find($('input#email-later')).prop('checked')) {
                        $('.files-data').attr('disabled',true);
                    } else {
                        $('.files-data').attr('disabled',false);
                    }  
                })
                .on('change', '#email-later', function (e) {
                ...
                .on('change', '.files-data', function(e){
                    ...
                    fd.append('action', 'wbc_cpf_upload_files');  
                    ...
                    $.ajax({
                        ...
                        beforeSend: function(xhr){
                            ...
                            if(size > 2000000){
                                ...
                                $('#custom-packaging .fileinput-button')
                                    ...
                                    .end()
                                    .find('.fa-spinner')
                                    .css({'margin-left': '10px', 'right': '30px', 'left': 'inherit'});
                            }
                        },
                        success: function(response){
                            if(response.response == 'ERROR'){
                                ...
                                $('#packaging_error_warning').text(response.error).css({color: '#E22B2B'});;                            
                                $('#packaging_imagename').attr('src', '').css({display:'none'});

                                //console.log('false'+' - '+response.response+' - '+response.error);

                            } else if (response.response == 'SUCCESS') {

                                $('#packaging_error_warning').text(response.filename ).css({display:'block', color: '#008000', 'font-size': '10px', 'text-align': 'center'});
                                $('#packaging_imagename').text(response.ImageName);
                ...
                .on('click', '#wbc_continue_to_cart', function(e) {
                    $('#wbc_continue_to_cart .fusion-button-text-left').text('Sending a copy...');
                    $('html,body').css('cursor','wait');
                    if($('input#customer-email').val() != ""){
                        //var emailFormat = /\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*/;
                        //if (emailFormat.test($('input#customer-email').val())){
                        $("#inf_field_FirstName").val($('input#customer-name').val());
                        $("#inf_field_Email").val($('input#customer-email').val());   
                        $("#infusion-form").submit();       
                        //} 
                        setTimeout(function () {
                ...
                .on('click', '#myInfoModal .close', function(e){
                    e.preventDefault();
                    window.location = "/cart";
                })

                .on('click', '#wbc_add_to_cart', function (e) {
                    //$('#myInfoModal').modal({backdrop: 'static', keyboard: false}) 
                    ...
                    Builder.collectDataToPost();  
                    Builder.data.free_colors = [];

                    if(checkConvert() == 'error'){
                        return;
                    }
                    ...
                    $("#selected_color_table tr").each(function(){
                        ...
                        var id =  ''+ $(this).attr("id");
                        var counter = id.split('-');
                        _adult_qtyE = $('#spanAdultup-' + counter[1]).attr('data-plus');
                        _medium_qtyE = $('#spanMediumup-' + counter[1]).attr('data-plus');
                        _youth_qtyE = $('#spanYouthup-' + counter[1]).attr('data-plus');

                        
                        if(_adult_qtyE!=undefined || _medium_qtyE!=undefined || _youth_qtyE !=undefined){
                            Builder.addFreeColor("", {
                                free: {
                                    adult: toInt(_adult_qtyE),
                                    medium: toInt(_medium_qtyE),
                                    youth: toInt(_youth_qtyE),
                    ...
                    $.ajax({
                        ...
                        if (response.success) { 
                            // if($('input#customer-email').val() != ""){
                            //     //captureAddcart(response.data.link);
                            // }
                            // setTimeout(function () {
                            //     window.location = "/cart";
                            // }, 5000);
                            //$("#inf_custom_Design1").val();
                ...
                .on('click', '#save_button', function (e) {
                    ...
                    if (Builder.data.total_qty > 0)
                    {
                        ...
                        if($('input#customer-email').val() != ""){
                            $('#SaveDesignEmail').val($('input#customer-email').val());
                        }
                    } else
                    {
                    ...
                    if ($('#SaveDesignEmail').val() != "" && emailFormat.test($('#SaveDesignEmail').val()))
                    {
                        ...
                        $.ajax({
                            ...
                            if (!response.success) {
                                ...
                                $("#inf_custom_Price0").val($('#price_handler').text());
                                //$("input[name=inf_option_TypeofLeads]").removeAttr('checked');
                                //$("#inf_option_TypeofLeads_398").attr('checked', 'checked');
                                $("#infusion-form").submit();
                            }
...
function validate_image(name) {
    name = name.toLowerCase();
    allowedFiles = [".png", ".jpeg", ".gif", ".cdr", ".psd", ".ai", ".pdf", ".eps", ".bmp", ".tiff",".jpg"];
}
