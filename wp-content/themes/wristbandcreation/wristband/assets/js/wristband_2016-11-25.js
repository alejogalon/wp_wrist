            ...
            Builder = {
                ...
                validateForm: function () {
                    ...
                    if (this.data.colors.length == 0) {
                        ...
                        this.appendAlertMsg('input quantity first!',$('#notify-customization-2'),'notify-customization-message-2');
                        this.appendAlertMsg('input quantity first!',$('.alert-warning-message'),'select-color-alert-2');
                    }
...
//              alert(colors[0] + '|' + colors[1] + '|' + colors[2]);
        ...
        if ((toInt($aq.val()) <= 0 && toInt($mq.val()) <= 0 && toInt($yq.val()) <= 0)) {
            ...
            // Builder.appendAlertMsg('Please select wristband color/text color/quantity.',$('#quantity-notice'),'quantity-notice-message');
             ...
             if($total_qty == 0){
                    ...
                    Builder.appendAlertMsg('input quantity first!',$('#notify-customization-2'),'notify-customization-message-2');
    ...
    $(document).ready(function () {
        ...
        $(document.body)
                    ...
                    if (slctd_product != undefined) {
                        ...
                        if (slctd_product.text_color) {
                            ...
                            for (var i in slctd_product.text_color) {
                                ...
                                var tpl = '<li><div class="color-selected color-box color-wrap ' + (i == 0 ? 'selected' : '') + '"><div data-name="{{name}}" data-color="{{color}}" style="background-color:{{color}}; height: 100%;"></div></div></li>';
                                ...
                                $('#wristband-palette-color ul').append((i == 0 ? custom_color : '') + render);
                ...
                .on('click', '#wristband-inside-item .color-wrap', function () {
                    var previous_color_selected = "", previous_element = -1;
                    if ($('#wristband-inside-item .color-wrap.selected').length)
                    {
                        previous_color_selected = $('#wristband-inside-item .color-wrap.selected').find('div').data('color');
                        previous_element = $('#wristband-inside-item .color-wrap.selected').find('div');
                    }
                    ...
                    var tbl_color = $('.edit-selection').find('.fa-undo').closest('a').data('name');
                    if (tbl_color) {
                        $('#wristband-inside-item .color-wrap').removeClass('selected');
                        $(this).addClass('selected');
                        return;
                    }
                    if ($(this).hasClass('added'))
                    ...
                    if ($.browser.chrome) {
                        ...
                        if ($("#bandtextcontainer")[0].getBoundingClientRect().width > size_[newwidth][$('.wbdiv').width()]['ChromeContMax']) {
                            ...
                            if ( $('#bandtextpathcont1')[0].offsetWidth > 260 ) {
                                ...
                                // console.log("here3");
                                // console.log($("#bandtextcontainer")[0].getBoundingClientRect().width);
                                // console.log($("#ifrontcontend")[0].getBoundingClientRect().width);
                                // console.log(size_[newwidth][$('.wbdiv').width()]['ChromeContMin']);
...
//                }
    ...
    //         return "asdaksjdklasjdlasjkd;asjd;asldjas;djas;ldjas;dkljaskl;djasjkl;d";
    //     }
