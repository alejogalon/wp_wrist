<?php 
 ...
 //Template Name: New Order Now Long Version
...
<!-- PRICE CHART -->
    ...
    <!-- START NEW ORDER NOW -->
        ...
        <div class="container">
          <div class="section-long-order-now">
            <div class="row">
              <div class="row-header">
                <div class="col-md-12 bg-gray-two" style="padding: 0;">
                  <span class="copy-step bg-blue-dark copy-white">Step 1</span>
                  <span class="copy-step-desc">Choose your Wristband Style</span>
                </div>
              </div>
              <div class="col-md-12 col-order-list bg-gray" style="padding: 0;">
                <ul>
                  <li>
                    <a href="#">
                    <div class="order-img-wrap">
                      <div class="order-item" style="background-image:url('<?php echo get_stylesheet_directory_uri(); ?>/wristband/assets/images/order-now-new.jpg');"></div>
                    </div>
                    <span class="order-title copy-font-fourteen copy-block text-center">Debossed</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-title copy-font-fourteen copy-block text-center">Imprinted</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-title copy-font-fourteen copy-block text-center">Debossed-Filled</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-title copy-font-fourteen copy-block text-center">Embossed</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
            ...
            <div class="row row-step-two">
              <div class="row-header">
                <div class="col-md-12 bg-gray-two" style="padding: 0;">
                  <span class="copy-step bg-blue-dark copy-white">Step 2</span>
                  <span class="copy-step-desc">Choose your Size</span>
                </div>
              </div>
              <div class="col-md-12 col-order-list bg-gray" style="padding: 0;">
                <ul>
                  <li>
                    <a href="#">
                    <div class="order-img-wrap order-size-wrap">
                      <div class="order-item order-item-size" style="background-image:url('<?php echo get_stylesheet_directory_uri(); ?>/wristband/assets/images/order-now-new-size.png');"></div>
                    </div>
                    <span class="order-size copy-font-fourteen copy-block text-center">1/4 inch</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-size copy-font-fourteen copy-block text-center">1/2 inch</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-size copy-font-fourteen copy-block text-center">3/4 inch</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-size copy-font-fourteen copy-block text-center">1 inch</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-size copy-font-fourteen copy-block text-center">1 & 1/4 inch</span>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                    ...
                    <span class="order-size copy-font-fourteen copy-block text-center">1 & 1/2 inch</span>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div class="row row-step-three">
              <div class="row-header">
                <div class="col-md-12 bg-gray-two" style="padding: 0;">
                  <span class="copy-step bg-blue-dark copy-white">Step 3</span>
                  <span class="copy-step-desc">Colors &amp; Quantity</span>

                  <div class="copy-float-right copy-marg-top-seven copy-spacing-two copy-marg-right-one copy-t-quantity">
                    <span class="copy-step-total">Total Quantity:</span><span class="copy-total-amount">0</span>
                    <span class="price-right">
                      <span class="copy-step-price">Price:</span> <span class="copy-dollar">$</span> <span class="copy-price">0.00</span>
                    </span>
                  </div>
                </div>
              </div>
              <div class="col-md-12 bg-gray" style="padding: 0;">

                <!-- NEW COLOR AND QUANTITY SECTION -->
                ...
                <div class="tab-content" id="wristband-color-items">
                  ...
                  <div class="tab-pane fade <?php echo $flag ? 'active in' : ''; ?>" id="tab-<?php echo sanitize_title($style); ?>">
                    ...
                    <div class="color-pantone">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-custom-color" data-toggle="modal" data-target="#myModal">

                          <span class="copy-custom-title copy-proxima-sbold copy-upper text-left">Custom <span class="copy-block">Color</span></span>
                          <span class="copy-custom-icon copy-float-right copy-relative"><i class="fa fa-plus-circle" aria-hidden="true"></i></span>
                          <span class="color-enabled" style="background-image:url('<?php echo get_stylesheet_directory_uri(); ?>/wristband/assets/images/wc-wristband-overlay.png');background-color: #a8aaa9; height: 130px; width: 100%; display: block; background-size: cover; background-position: center; background-repeat: no-repeat; margin-top: 10px;" data-toggle="tooltip" data-placement="top"
                        title="Custom Color">
                          </span>
                        </button>
                        <div class="data-desc">
                           <div class="row row-text copy-marg-top-ten">
                             <div class="col-md-5">
                               <span class="copy-text-color">Text Color</span>
                             </div>
                             <div class="col-md-7 col-sel-text">
                              <div class="desc-icon">
                           ...
                           <div class="row row-quantity copy-marg-top-ten">
                             <div class="col-md-12">
                               <div id="quantity_group_field" class="col-color">
                                <p class="form-row quantity-row fusion-one-fourth one_third fusion-layout-column fusion-spacing-yes">
                                  ...
                                  <input type="number" name="qty_adult" id="qty_adult" min="0" class="input-text form-control" style="padding: 0; text-align: center;" placeholder="QTY">
                                  <label class="" for="qty_adult">Adult</label>
                                </p>
                                <p class="form-row quantity-row fusion-one-fourth one_third fusion-layout-column fusion-spacing-yes">
                                  <!-- <label class="form-group-heading CssTitleBlack" for="qty_medium">Medium</label> -->
                                  <input type="number" name="qty_medium" id="qty_medium"  min="0" class="input-text form-control" style="padding: 0; text-align: center;" placeholder="QTY">
                                ...
                                <p class="form-row form-row-last fusion-one-fourth one_third fusion-layout-column fusion-column-last fusion-spacing-yes">
                                  ...
                                  <input type="number" name="qty_youth" id="qty_youth"  min="0" class="input-text " style="padding: 0; text-align: center;" placeholder="QTY">
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    ...
                                    <button type="button" class="btn btn-primary copy-float-right btn-done">Done</button>
                                    ...
                                    <div class="tab-pane active" id="colorchart">
                                      <ul class="color-pantone-list">
                                        <?php if (isset($GLOBALS['wbc_settings']->pantone_color)):
                                          ...
                                          <li>
                                          <a>
                                              <div class="color-chart-wrapper" style="color: <?php echo $pantone->color_number;?>; background-color: <?php echo $pantone->color_number;?>;">
            ...
            <div class="row row-step-four">
              <div class="row-header">
                <div class="col-md-12 bg-gray-two" style="padding: 0;">
                  <span class="copy-step bg-blue-dark copy-white">Step 4</span>
                  <span class="copy-step-desc">Customize your wristband</span>

                  <div class="copy-float-right copy-marg-top-seven copy-spacing-two copy-marg-right-one">
                    <span class="copy-step-total">Total Quantity:</span><span class="copy-total-amount">0</span>
                    <span class="copy-step-price">Price:</span> <span class="copy-dollar">$</span> <span class="copy-price">0.00</span>
                  </div>
                </div>
              ...
              <div class="section-order-page">
              <div class="container p-0 copy-hidden bg-gray">
                <div id="wdisplay101" class="text-center bg-white">
                  <div class="row row-preview">
                    <div id="front-back-text-container" class="row" style="background-color: #505050; box-shadow: 0 0 2px 0 #505050; background-repeat: no-repeat; background-size: cover; font-family: Arial;">
                      ...
                      <div id="swirlcolor" class="col-swirl swirlcolor" style="display:none">
                        <div class="list-swirl first-color col-preview" style="background: #505050; position: absolute; width: 100%;">
                        </div>
                        <div class="list-swirl second-color col-preview" style="background: #505050;position: absolute; width: 100%;">
                            <div class="col-md-6">
                        ...
                        <div class="list-swirl third-color col-preview" style="background: #505050; position: absolute; width: 100%">
                          <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="col-preview col-front" style="font-size: 30px; color: #fff;">
                    ...
                    <div id="full-text-container" class="row" style="background-color: rgb(80, 80, 80); box-shadow: 0 0 2px 0 rgb(80, 80, 80); background-repeat: no-repeat; background-size: cover; font-family: Arial;display:none; position:relative">
                    <div id="#segmentedcolor" class="seg" style="display:none">
                      <div class="segd seg-left"></div>
                      <div class="segd seg-center"></div>
                      <div class="segd seg-right"></div>
                    ...
                    <!-- Swirl Front and Back -->
                    <div id="swirlcolor" class="col-swirl swirlcolor" style="display:none">
                      <div class="list-swirl first-color col-preview" style="background: rgb(80, 80, 80); position: absolute; width: 100%; height: 60px;"></div>
                      <div class="list-swirl second-color col-preview" style="background: rgb(80, 80, 80);position: absolute; width: 100%;">
                          <div class="col-md-6">
                            <div class="col-preview col-swirl-two col-swirl-front" style="height: 60px;">
                            </div>
                          </div>
                      ...
                      <div class="list-swirl third-color col-preview" style="background: rgb(80, 80, 80); position: absolute; width: 100%">
                        <div class="col-md-6">
                            <div class="col-preview col-swirl-two" style="height: 60px;">
                            </div>
                          </div>
                    ...
                    <div class="col-md-12 wristbandNoPadding">
                      <div class="col-preview col-inside" style="font-size: 30px; color: rgba(255, 255, 255, 0.2);">
                  ...
                  <div id="figured-container" class="row copy-marg-top row-figured" style="display:none; background-color: rgb(80, 80, 80); box-shadow: 0 0 2px 0 rgb(80, 80, 80); background-repeat: no-repeat; background-size: cover; font-family: Arial;">
                  <!-- Segmented Front and Back -->
                  <div id="segmentedcolor" class="seg" style="display:none">
                  ...
                  <div class="col-md-12">
                    ...
                    <div id="box_figured" class="box-figured" style="background: rgb(80, 80, 80);">
              ...
              <!-- END FIGURED ROW -->
                    ...
                    <div id="inside-text-container" class="row copy-marg-top" style="background-color: rgb(80, 80, 80); box-shadow: 0 0 2px 0 rgb(80, 80, 80); background-repeat: no-repeat; background-size: cover; font-family: Arial;">
                    <!-- Segmented Inside -->
                      <div id="#segmentedcolor" class="seg" style="display:none">
                        <div class="segd seg-left"></div>
                        <div class="segd seg-center"></div>
                    ...
                    <!-- Swirl Front and Back -->
                      <div id="swirlcolor" class="col-swirl swirlcolor" style="display:none">
                        <div class="list-swirl first-color col-preview" style="background: rgb(80, 80, 80); position: absolute; width: 100%; height: 60px;">
                        </div>
                        <div class="list-swirl second-color col-preview" style="background: rgb(80, 80, 80);position: absolute; width: 100%;">
                            <div class="col-md-6">
                              <div class="col-preview col-swirl-two col-swirl-front" style="height: 60px;">
                      ...
                      <div class="col-md-12 wristbandNoPadding">
                        <div class="col-preview col-inside">
                          <div id="InsideStartClipArt101" class="copy-preview-clipart copy-display-inline">
                            ...
                            <h3 id="Im101" class="copy-spacing-1 copy-display-inline inside-msg-text copy-preview-font" style="color: rgba(255, 255, 255, 0.2);">
                              <!-- Inside Message -->
                            </h3>
                  ...
                  <div class="col-md-6" style="display: none;">
                    ...
                    <div class="col-md-12">
                      <div class="col-wristband">
                          <div class="col-message-select">
                              <div class="row">
                                <div class="col-md-3">
                                  <span class="copy-font-fourteen">Message Style</span>
                                </div>
                                <div class="col-md-9">
                                  <div class="form-group">
                                    <div class="radio">
                          ...
                          <div class="col-content-holder col-wrist-details">
                              ...
                              <?php endif; ?>
                                  ...
                                  <div class="form-group">
                                      <label for="" class="col-sm-4 control-label p-0">Font Size</label>
                                      <div class="col-sm-8 p-0">
                                          <div class="select-button">
                                              <div class="dropdown form-control">
                                                <input value="Normal" id="selectFontSize" type="text" name="selectFontSize" readonly="" class="input-select" style=" font-family: 'ProximaNovaReg';">
                                      
                                                <span class="dd-pointer dd-pointer-down in"></span>
                                                <div id="fontSizeID" class="dropdown-menu font-dropdown fadeFont in">
                                                  <ul class="font-class">
                                                    <li>
                                                      <div class="inner-content">
                                                        <label class="fontliststyle" style="font-size: 24px !important;"> 
                                                          24px
                                                        </label>
                                                        <br>
                                                        <label class="font-label">Normal Size</label>
                                                        <input class="fontvalue" type="hidden" value="24px">
                                                      </div>
                                                    </li>
                                                    <li>
                                                      <div class="inner-content">
                                                        <label class="fontliststyle" style="font-size: 30px !important;">
                                                          30px
                                                        </label>
                                                        <br>
                                                        <label class="font-label">Header Size</label>
                                                        <input class="fontvalue" type="hidden" value="30px">
                                                      </div>
                                                    </li>
                                                    <li>
                                                      <div class="inner-content">
                                                        <label class="fontliststyle" style="font-size: 48px !important;">
                                                          48px
                                                        </label>
                                                        <br>
                                                        <label class="font-label">Large Size</label>
                                                        <input class="fontvalue" type="hidden" value="48px">
                                                      </div>
                                                    </li>
                                                </ul>
                                            </div>
                    ...
                    <div class="col-md-12 col-step-five">
                      <div class="row-header">
                        <div class="col-md-12 bg-gray-two" style="padding: 0;">
                          <span class="copy-step bg-blue-dark copy-white">Step 5</span>
                          <span class="copy-step-desc">Additional Options</span>
                        </div>
                      </div>     
                  <!-- Additional options -->
                    <?php if (isset($GLOBALS['wbc_settings']->additional_options)): ?>
                      ...
                      <div class="col-md-12 p-0 col-summ col-step-6">
                          <div class="col-holder col-holder-summ" style="display: none;">
                              <div class="col-title">
                                  <h5>Summary</h5>
                              </div>
                          ...
                          <div class="col-holder">
                              <div class="row-header">
                                <div class="col-md-12 bg-gray-two" style="padding: 0;">
                                  <span class="copy-step bg-blue-dark copy-white">Step 6</span>
                                  <span class="copy-step-desc">Production &amp; Shipping</span>
                                          ...
                                          <p class="form-row form-row-wide">
                                            <label>
                                              ...
                                              <span class="radio-img">
                                                <span class="radion-img-item" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/wristband/assets/images/shipping_country_china.jpg');"></span>
                                              </span>
                                              ...
                                              <span class="copy-customize_loc copy-block">
                              ...
                              <div class="col-holder col-order-total"> 
                                <div class="col-content-holder col-total">
                                    <div class="total-details">
                                        <div class="col-total-content" style="display: none;">
