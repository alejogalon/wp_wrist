			        ...
			        <div class="product product-table">
			            ...
			            <!-- Nav tabs -->
				       	<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation" class="">
								<a href="#val4" aria-controls="val3/8" role="tab" data-toggle="tab">3/8 inch</a></li>
							<li role="presentation" class="active">
								<a href="#val5" aria-controls="val1/2" role="tab" data-toggle="tab">1/2 inch</a></li>
							<li role="presentation" class="">
								<a href="#val12" aria-controls="val3/8" role="tab" data-toggle="tab">5/8 inch</a></li>
				        </ul>
				        <!-- Tab panes -->
			            <div class="tab-content">
			                 ...
			                 <div role="tabpanel" class="tab-pane active" id="val5">
			                    ...
			                    <div role="tabpanel" class="tab-pane" id="val12">
			                    <div class="table-responsive">
			                        <table class="table text-center">
			                            <thead>
			                                <tr>
