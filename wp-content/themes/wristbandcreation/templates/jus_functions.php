...
function order_fields($fields) {
	...
	foreach($ship_order as $field_ship)
	{
		$ordered_field_ships[$field_ship] = $fields["shipping"][$field_ship];
	}

	$fields["shipping"] = $ordered_field_ships;

	$fields['order']['order_comments']['placeholder'] = 'Delivery Notes';
