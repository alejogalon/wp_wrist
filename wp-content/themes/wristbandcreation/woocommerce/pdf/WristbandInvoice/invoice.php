...
<p class="copy-invoice-instruction">
	Your order is on-hold until we confirm payment has been received.

	Please send your check payments to:
	Custom Wristbands Inc.
	20345 Rue Crevier Unit 509
	Santa Clarita, CA 91351
	United States
	<a href="tel:(800) 403-8050">(800) 403-8050</a>

	For Purchase Orders, you can mail it to the address above or email it to <a href="mailto:sales@wristbandcreation.com">sales@wristbandcreation.com</a>. Alternatively, you can fax it to (800) 807-0672.

	Please indicate your order number on the check or Purchase Order.

	Production of your order will only begin once we receive your check or Purchase Order. Any questions please give us a call at <a href="tel:(800) 403-8050">(800) 403-8050</a>.
...
<!-- <table class="order-details">
	...
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $wpo_wcpdf->export->template_type, $wpo_wcpdf->export->order, $item_id ); ?>">
			...
			<td class="font-style"><span>Font Style</span><?php echo $item['font']; ?></td>
		</tr>
