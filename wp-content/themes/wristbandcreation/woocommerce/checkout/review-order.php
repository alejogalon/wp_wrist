...
<table class="shop_table woocommerce-checkout-review-order-table woocomerce-checkout-table">
	<thead>
	<tr>
		<th class="product-details details-title"><?php _e( 'Your Order', 'woocommerce' ); ?></th>
        <a class="product-link" href="<?php echo WC()->cart->get_cart_url(); ?>" class="button wc-forward"><?php _e( 'Edit Cart', 'woocommerce' ); ?> <i class="fa fa-level-up" aria-hidden="true"></i></a>
