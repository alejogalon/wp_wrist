					...
					<div class="row row-share">
						...
						<div class="col-md-6 p-0 text-right">
							<ul>
								...
								<!-- <li>
									<a class="fa-custom" href="http://pinterest.com/pin/create/bookmarklet/?media=[MEDIA]&url=<?php echo get_permalink(); ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Share on Google Plus" target="_blank"><i class="fa fa-pinterest"></i></a>
								</li> -->
