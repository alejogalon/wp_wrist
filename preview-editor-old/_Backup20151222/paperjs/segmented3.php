...
//            copybandUpLeft.fillColor = 'black';
            var bandInnerBoderCenter = new Path();            
            bandInnerBoderCenter.add(new Point(53, 80));             
            bandInnerBoderCenter.add(new Point(90, 60));
            
            bandInnerBoderCenter.add(new Point(180, 48));//center left   
            
            
            bandInnerBoderCenter.add(new Point(265, 60));
            bandInnerBoderCenter.add(new Point(301.5, 77));
            
            bandInnerBoderCenter.add(new Point(294, 100));
            bandInnerBoderCenter.add(new Point(250, 180));            
            bandInnerBoderCenter.add(new Point(110, 180));
            bandInnerBoderCenter.add(new Point(62.5, 100));
    
            bandInnerBoderCenter.closed = true;
            var copybandInnerBoderCenter = bandInnerBoderCenter.clone();
            copybandInnerBoderCenter.position.x += 0;
            copybandInnerBoderCenter.position.y += -7;
            copybandInnerBoderCenter.smooth();               
            copybandInnerBoderCenter.smooth();

            copybandInnerBoderCenter.fillColor = {
            gradient: {
                stops: [['white', 0.1],['#4DDB4D', 0.8]],
                radial: true
            },   
            origin: {x: 165, y: 0},
            destination: borderUp.bounds.rightCenter    
            }
//            copybandInnerBoderCenter.fullySelected = true;
//            bandOut.fillColor = 'black';
        ...
        bandInner.removeSegment(1);
            ...
            var bandInnerCenter = new Path();   
            bandInnerCenter.add(new Point(56, 81));
            bandInnerCenter.add(new Point(55, 78));             
            bandInnerCenter.add(new Point(57, 76));             
                                    
            bandInnerCenter.add(new Point(90, 58.2));
            
            bandInnerCenter.add(new Point(180, 46));//center left   
            
            
            bandInnerCenter.add(new Point(265, 59));
            
            bandInnerCenter.add(new Point(300, 76.7));
            bandInnerCenter.add(new Point(291, 77));
            bandInnerCenter.add(new Point(299.5, 75.5));
            
            bandInnerCenter.add(new Point(295, 100));
            bandInnerCenter.add(new Point(250, 180));            
            bandInnerCenter.add(new Point(110, 180));
            bandInnerCenter.add(new Point(60, 100));
    
            bandInnerCenter.closed = true;
            var copybandInnerCenter = bandInnerCenter.clone();
            copybandInnerCenter.position.x += 0;
            copybandInnerCenter.position.y += -0.5;
            copybandInnerCenter.smooth();               
            copybandInnerCenter.smooth();

            copybandInnerCenter.fillColor = {
            gradient: {
                stops: [['white', 0.1],['#4DDB4D', 0.7], ['black', 1]],                
                radial: true
            },   
            origin: {x: 165, y: 0},
            destination: bandInner.bounds.rightCenter    
            }
//            copybandInnerCenter.fullySelected = true;
//            bandOut.fillColor = 'black';
