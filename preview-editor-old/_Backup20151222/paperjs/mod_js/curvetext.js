...
//        canvasDiv.innerHTML = '<canvas id="layer0" width="350" height="230"></canvas>'; //for IE
//        canvas = document.getElementById('layer0');
        canvas = document.getElementById('canvas');
        ctx = canvas.getContext('2d');
        ctx.fillStyle = 'red';
        ctx.font = '40px Miriam';
    ...
    function drawStack()
    {
        //to change max character limit, just edit "maxChar: 50" value.
        Ribbon = {maxChar: 16, startX: points[0], startY: points[1],
...
//        ctx.stroke();// line
    ...
    function FillRibbon(text, Ribbon)
    {
        ...
        letterPadding = ctx.measureText(" ").width / 8;
        w = ribbon.length;
