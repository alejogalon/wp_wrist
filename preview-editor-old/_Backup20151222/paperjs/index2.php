...
//            origin: CopyborderDown.position,
            ...
            bandOut.add(new Point(100, 130));//added lower-left  
            bandOut.add(new Point(55, 110));//lower-left     
            bandOut.add(new Point(50, 50));//L corner
            bandOut.add(new Point(60, 55));
            
            bandOut.add(new Point(100, 65));
            bandOut.add(new Point(150, 70));
            
            bandOut.add(new Point(200, 72));//Upper Center
            
            bandOut.add(new Point(250, 70));
            bandOut.add(new Point(300, 65));
    
            bandOut.add(new Point(340, 55));//inverted L corner
            bandOut.add(new Point(350, 50));//inverted L corner
            bandOut.add(new Point(345, 110));//lower-right
            bandOut.add(new Point(300, 130));//added lower-right
            bandOut.add(new Point(200, 135));//lower-center
...
//            bandOut.fillColor = 'black';
            ...
            copybandOut.position.x += 350;
            copybandOut.position.y += 100;
            copybandOut.smooth();

copybandOut.strokeColor = 'black';
//copybandOut.selected = true;
...
<script type="text/javascript" src="mod_js/curvetext.js"></script>
    ...
    <body>
        ...
        <canvas id="myCanvas" width="750" height="460"></canvas>
