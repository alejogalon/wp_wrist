...
//                        }                        
            ...
            $("#front-color").keyup(function () {
                ...
                document.getElementById("bandtextcont1").style.fill = $('#front-color').val();
                document.getElementById("bandtextcont1").style.opacity = "1";
                document.getElementById("bandtextcont2").style.fill = $('#front-color').val();
...
*/
    ...
    <body>
        ...
        <div id="mycontainer" class="container">
            ...
            <path id="MyPath2" fill-opacity="0" d="M17 96 q 125 25 255 2"/>
